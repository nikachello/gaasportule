    ...
    <div className="w-full max-w-sm flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          უკვე გაქვთ ანგარიში?{" "}
          <Link href="/sign-in" className="text-default-blue font-medium">
            შესვლა
          </Link>
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl border border-black/10 bg-white text-sm font-medium hover:bg-gray-50 transition-colors"
        >
